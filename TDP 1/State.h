...
class State {
    public:
		...
		int linearConflict(); // Calcula la cantidad de conflictos lineales
		void linearConflict2(int opt_i, int opt_j, int i, int j); // Calcula la cantidad de conflictos lineales en una fila
